...
export const Sidebar = ({ setIsOpen, setWhichActive, whichActive }) => {
  ...
  return (
    <aside
      className={`bg-[hsl(34_62%_95%)] px-4 max-lg:w-full max-lg:h-[5rem] 
         border border-l-gray-400 h-screen fixed  w-[5.5rem] top-0 left-0 
           max-lg:border-0`}
    >
      <div className="w-full flex  max-lg:flex-row max-lg:justify-between flex-col justify-center items-center pt-5 text-center gap-4 text-[rgb(107_98_85)]">
        <div
          id="discover"
          onClick={handleClick}
